...
static uint8_t FLAME_SENSOR_PIN    = 4;
static uint8_t BUZZER_PIN = 21;
//---------------------------------------------------
//PIR Motion Sensor
boolean FLAME_SENSOR_STATE_NEW     = LOW;  // current state
boolean FLAME_SENSOR_STATE_OLD     = LOW;  // previous state
//---------------------------------------------------
...
void setup(){
  ...
  //------------------------------------------------------------------------------
  Node my_node;    
  my_node = RMaker.initNode("Tech_Trends_Shameer");
  //------------------------------------------------------------------------------
...
void detectMotion() {
  if(SECURITY_STATE == true) {
    FLAME_SENSOR_STATE_OLD = FLAME_SENSOR_STATE_NEW; // store old state
    FLAME_SENSOR_STATE_NEW = digitalRead(FLAME_SENSOR_PIN); //read new state
    //------------------------------------------------------------------------
    Serial.println("FLAME_SENSOR_STATE_OLD");
     Serial.print(FLAME_SENSOR_STATE_NEW);
    Serial.println("FLAME_SENSOR_STATE_NEW"); 
    Serial.println(FLAME_SENSOR_STATE_NEW);
    //if(FLAME_SENSOR_STATE_OLD == LOW && FLAME_SENSOR_STATE_NEW == HIGH) {
      if(FLAME_SENSOR_STATE_NEW == 0) {
      Serial.println("Fire detected!");
      esp_rmaker_raise_alert("Security Alert!Fire is detected.");
