...
base_dir = 'D:/For Study Only/Study For Better Future/BCU/Đồ án đổi mới sáng tạo/Innovation Project/Fire-and-Smoke-Detection/Code/Thermal/'
threshold = 200
...
def main():
    ...
    fps = video.get(cv2.CAP_PROP_FPS) #xem toc do thuc the khi qua video
    print(fps) # xem toc do , o day la 25 anh tren giay
    wait_time = 1900/fps # dong nhat don vi
    video_frames = []
